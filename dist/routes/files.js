...
router.put('/:collection/:id', middleware_1.validateJWT, validateUpload_1.validateUpload, (0, express_validator_1.check)('collection').custom(c => (0, dbValidator_1.authorizedCollection)(c, ['users', 'category'])), middleware_1.validateFields, files_1.updateFile);
